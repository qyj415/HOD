  ...
  <head>
	...
	<script type="text/javascript">
		function checkForm()
		{
			...
			{
				Ext.MessageBox.alert('提示','新密码输入不合规范，请重新输入!');
				return false;
			}
			...
			{
				Ext.MessageBox.alert('提示','确认密码输入不一致，请重新输入!');
				return false;
			}
		}
	</script>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
							<!-- 可以写form -->
							<form action="${pageContext.request.contextPath}/hod2000Operator!doChangePwd.do" method="post">
								<input type="hidden" value="${user.operId }" name="hod2000Operator.operId">
								<table cellpadding="0" cellspacing="0" border="0" height="150px" align="center" id="tab">
									<tr>
										<td>新密码：</td>
										<td><input type="password" id="password" name="pwd"/><span>必填，6-16位字符</span></td>
									</tr>
									<tr>
										<td>密码确认：</td>
										<td><input type="password" id="password2"/><span>必填，6-16位字符</span></td>
									</tr>
									<tr>
