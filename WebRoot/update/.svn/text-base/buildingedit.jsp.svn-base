  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
             $('#buildingEditForm input').keyup(trimkeyup);
             $('#buildingEditForm textarea').keyup(trimkeyup);
 		});
	</script>
  </head>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
							<!-- 可以写form -->
							<form action="${pageContext.request.contextPath}/hod2000Building!doUpdate.do" method="post" id="buildingEditForm">
								<input type="hidden" value="${hod2000Building.buildingId }" name="buildingId">
								<table cellpadding="0" cellspacing="0" border="0" height="300px" width="50%" align="center" id="tab">
									<tr>
										<td>楼栋名称：</td>
										<td><input type="text" id="buildingName" name="buildingName" value="${hod2000Building.buildingName }"/><span>必填，2-32位字符</span></td>
									</tr>
									<tr>
										<td>备注信息：</td>
										<td><textarea cols="30" rows="6" id="buildingRemark" name="buildingRemark">${hod2000Building.buildingRemark }</textarea><span>最长不超过128个字符</span></td>
									</tr>
									<tr>
