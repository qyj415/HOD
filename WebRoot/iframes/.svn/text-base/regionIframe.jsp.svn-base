											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="95%" class="STYLE2">
														<B>当前位置</B>：[地址信息]-[<font color='red'>省份信息</font>]
													</td>
												</tr>
											</table>
										</td>
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td class="STYLE3">省份名称</td>
									</tr>
									<!--------------------------------------------------->
									<c:forEach items="${dataList}" var="v" varStatus="num">
										<tr>
											<td class="STYLE1">${num.index+1}</td>
											<td class="STYLE1">${v.regionCode}</td>
											<td class="STYLE1"><a style="color:#f60" href="${pageContext.request.contextPath}/hod2000City!doSelect.do?regionId=${v.regionId }">${v.regionName}</a></td>
										</tr>
									</c:forEach>
									<!--------------------------------------------------->
								</table>
