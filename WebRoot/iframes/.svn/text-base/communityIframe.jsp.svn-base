											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="95%" class="STYLE2">
														<B>当前位置</B>：[地址信息]-[<font color='red'>${villageName }</font>]-[小区信息]
													</td>
												</tr>
											</table>
										</td>
												...
												<tr>
													...
													<td width="90">
														<table width="99%" border="0" cellpadding="0"
															...
															<tr>
																<td class="STYLE2">
																	<a href="${pageContext.request.contextPath}/form/communityadd.jsp?villageId=${villageId }"><div class="addbtn"></div></a>
																</td>
															</tr>
														</table>
													</td>
													<td width="90">
														<table width="99%" border="0" cellpadding="0"
															...
															<tr>
																<td class="STYLE2">
																	<a id="deleteById" href="#" onclick="doDeleteX('${pageContext.request.contextPath}/hod2000Community!doDelete.do?villageId=${villageId }');"><div class="delbtn"></div></a>
																</td>
															</tr>
														</table>
													</td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
								...
								<DIV id="searchDIV">
							 		<%@include file="/inc/addressUpload.jsp" %>
								</DIV>
							</td>
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td class="STYLE3">所属城乡/街道办</td>
										<td class="STYLE3">小区名称</td>
									...
									<c:forEach items="${list}" var="v" varStatus="num">
										<tr>
											<td height="20" bgcolor="#FFFFFF"  class="STYLE3"><div align="center"><input type="checkbox" name="ckId" id="dataList" value="${v.communityId}" /></div></td>
											<td class="STYLE1">${num.index+1}</td>
											<td class="STYLE1">${villageName}</td>
											<td class="STYLE1"><a style="color:#f60" href="${pageContext.request.contextPath}/hod2000Building!doSelect.do?communityId=${v.communityId }">${v.communityName}</a></td>
											<td class="STYLE1">${v.communityRemark}</td>
											<td class="STYLE1">
												<a style="color:#f60" href="${pageContext.request.contextPath}/hod2000Community!toUpdate.do?id=${v.communityId}&villageId=${villageId }">【编辑】</a>
												<a style="color:#f60" id="deleteById" href="${pageContext.request.contextPath}/hod2000Community!doDelete.do?delIds=${v.communityId}&villageId=${villageId }" onclick="return doDeleteById();">【删除】</a>
											</td>
										</tr>
									</c:forEach>
									<!--------------------------------------------------->
						...
						<tr>
							...
							<td>
								<jsp:include page="/inc/page.jsp" flush="true">
									<jsp:param name="params" value="&villageId=${villageId}"/>
								</jsp:include>
							</td>
