											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="95%" class="STYLE2">
														<B>当前位置</B>：[地址信息]-[<font color='red'>${cityName }</font>]-[区县信息]
													</td>
												</tr>
											</table>
										</td>
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td class="STYLE3">所属城市</td>
										<td class="STYLE3">行政编号</td>
										<td class="STYLE3">区/县名称</td>
									</tr>
									<!--------------------------------------------------->
									<c:forEach items="${dataList}" var="v" varStatus="num">
										<tr>
											<td class="STYLE1">${num.index+1}</td>
											<td class="STYLE1">${cityName}</td>
											<td class="STYLE1">${v.countyCode}</td>
											<td class="STYLE1"><a style="color:#f60" href="${pageContext.request.contextPath}/hod2000Village!doSelect.do?countyId=${v.countyId }">${v.countyName}</a></td>
										</tr>
									</c:forEach>
									<!--------------------------------------------------->
								</table>
						...
						<tr>
							...
							<td>
								<jsp:include page="/inc/page.jsp" flush="true">
									<jsp:param name="params" value="&cityId=${cityId}"/>
								</jsp:include>
							</td>
