...
<link href="${pageContext.request.contextPath}/js/datePicker/skin/WdatePicker.css" rel="stylesheet" type="text/css"/>
		...
		<div>
				<table class="repCnd">
				<tr class="repCnd">
					<td class="repCndEditRight" nowrap="nowrap" style="text-align: right;"><input type="button" class="addbtn1" value="" onclick="window.location.href='${pageContext.request.contextPath}/form/priceadd.jsp'"/></td>
				</tr>
				</table>
		</div>
