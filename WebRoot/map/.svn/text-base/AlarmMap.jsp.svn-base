...
<html>
  <head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/ext3/resources/css/ext-all.css" type="text/css"></link>
		...
		<script type="text/javascript" src="http://api.map.baidu.com/api?&v=1.3"></script>       
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/AlarmMapPanel.js"> </script>
		...
		<script type="text/javascript">
			Ext.onReady(function() { 
				...
				var topTreePanel = new Ext.ld.checkAreaTree({
				    	id: 'AlarmMapTreePanle',
				        renderTo:"alarmTreePanel",
				        width:230,
				...
				Ext.Ajax.request({
					...
					success : function(res) {
						...
						if(result.success==true)
						{
							...
							Ext.getCmp('alarmmap').onFindTerminal(params);//集中器在地图上的定位查询
						}
					},
  ...
  <div id="alarmTreePanel" style="width: 230px;float: left;"></div>
  <div id="container" style="float: left;"></div>
    ...
    this.mapObj = Ext.getCmp('alarmmap');
    </script>
</html>
