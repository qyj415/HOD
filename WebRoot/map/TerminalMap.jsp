...
<html>
  <head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/ext3/resources/css/ext-all.css" type="text/css"></link>
		...
		<script type="text/javascript" src="http://api.map.baidu.com/api?&v=1.3"></script>       
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/TerminalMapPanel.js"> </script>
		...
		<script type="text/javascript">
			Ext.onReady(function() { 
				...
				var topTreePanel = new Ext.ld.checkAreaTree({
				    	id: 'TerminalMapTreePanle',
				        renderTo:"terminalTreePanel",
				        width:230,
				...
				Ext.Ajax.request({
					...
					success : function(res) {
						...
						if(result.success==true)
						{
							...
							Ext.getCmp('terminalmap').onFindTerminal(params);//集中器在地图上的定位查询
						}
					},
  ...
  <div id="terminalTreePanel" style="width: 230px;float: left;"></div>
  <div id="container" style="float: left;"></div>
  	...
  	<script type="text/javascript">
        ...
        tbar : new Ext.Toolbar({
						items : [{
									...
									iconAlign : 'left',
									handler : function() {
										location.href='${pageContext.request.contextPath}/show/concentratorlist.jsp';
									}.createDelegate(this)
								}, '-', {
									xtype : 'button',
									text : '首页',
    ...
    this.mapObj = Ext.getCmp('terminalmap');
    </script>
</html>
