  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
             $('#unitAddForm input').keyup(trimkeyup);
             $('#unitAddForm textarea').keyup(trimkeyup);
 		});
	</script>
  </head>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
							<!-- 可以写form -->
							<form action="${pageContext.request.contextPath}/hod2000Unit!doSave.do" method="post" id="unitAddForm">
								<input type="hidden" name="buildingId" id="buildingId" value="${param.buildingId }">
								<table cellpadding="0" cellspacing="0" border="0" height="350px" width="50%" align="center" id="tab">
									<tr>
										<td>单元名称：</td>
										<td><input type="text" id="unitName" name="hod2000Unit.unitName"/><span>必填，2-32位字符</span></td>
									</tr>
									<tr>
										<td>备注信息：</td>
										<td><textarea cols="30" rows="6" id="unitRemark" name="hod2000Unit.unitRemark"></textarea><span>最长不超过128个字符</span></td>
									</tr>
									<tr>
