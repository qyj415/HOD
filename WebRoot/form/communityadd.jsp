  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
             $('#communityAddForm input').keyup(trimkeyup);
             $('#communityAddForm textarea').keyup(trimkeyup);
 		});
	</script>
  </head>
				...
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
							<!-- 可以写form -->
							<form action="${pageContext.request.contextPath}/hod2000Community!doSave.do" method="post" id="communityAddForm">
								<input type="hidden" name="villageId" id="villageId" value="${param.villageId }">
								<table cellpadding="0" cellspacing="0" border="0" height="300px" width="45%" align="center" id="tab">
									<tr>
										<td>小区名称：</td>
										<td><input type="text" id="communityName" name="hod2000Community.communityName"/><span>必填，2-32位字符</span></td>
									</tr>
									<tr>
										<td>备注信息：</td>
										<td><textarea cols="30" rows="6" id="communityRemark" name="hod2000Community.communityRemark"></textarea><span>最长不超过128个字符</span></td>
									</tr>
									<tr>
